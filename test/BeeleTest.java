...
public class BeeleTest {
    class Beele extends Tavunu{
        Beele(){
            super();
        }
        
        Beele(String name, int birthYear, int pava) {
            super(name, 1, pava);
        }
    }
    @Test
    public void testCtorValidParams() {
        ...
        tv = new Beele("Dghaga", 1944, 21);
        assertEquals("Dghaga", tv.getName());
        assertEquals(21, tv.getPava());
        assertEquals(1944, tv.getBirthYear());

        tv = new Beele("Dghaga", 1944, 60);
        assertEquals("Dghaga", tv.getName());
        assertEquals(60, tv.getPava());
        assertEquals(1944, tv.getBirthYear());     
        
        tv = new Beele("Dghaga", 1944, 80);
        assertEquals("Dghaga", tv.getName());
    ...
    public void testInheritance() {
        var tv = new Beele("Dghaga", 1945, 60);
    ...
    public void testToString() {
        var tv = new Beele("Dghaga", 1944, 62);
        
        assertEquals("Dghaga born in 1944 is a Beele with 62 pava.", tv.toString());
    }
    ...
    public void testReceivePava() {
        var tv = new Beele("Dghaga", 1944, 60);
